...
ActiveRecord::Schema[7.1].define(version: 2025_04_03_135836) do
  ...
  create_table "post_tag_relations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "post_id"
    t.bigint "tag_id"
    t.datetime "created_at", null: false
